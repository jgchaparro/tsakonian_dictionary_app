"""
Django settings for TsakonianDict project.
...
SECRET_KEY = 'django-insecure-=qmbw19)+^m653^vmtz3q0(ij)g!-p(day6s&g9(j2$utm%9i*'
...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware", # Added for Azure deployment
...
ROOT_URLCONF = 'TsakonianDict.urls'
...
STATICFILES_DIRS = (str(BASE_DIR.joinpath('dictionary/static')),)
